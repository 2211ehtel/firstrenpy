...
init -1 python hide:
    ...
    config.window_title = u"FirstRenpy"
...
python early:
    config.save_directory = "FirstRenpy-1471646109"
...
init python:
    ...
    build.directory_name = "FirstRenpy-1.0"
    ...
    ## クリックするとゲームがスタートします。
    build.executable_name = "FirstRenpy"
